...
class LinkElement(unittest.TestCase):
    ...
    def test_a1(self):
        ...
        odt = xhtml2odt(html)
        self.assertEquals(odt, '<text:a xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="target">Test</text:a>')
  ...
  <text:a xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="target">Test</text:a>
    ...
    def test_a_target_2(self):
        ...
        odt = xhtml2odt(html, dict(url="http://localhost/localpage"))
        self.assertEquals(odt, '<text:a xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="http://localhost/otherpage#target">Test</text:a>')
    ...
    def test_a_target_3(self):
        ...
        odt = xhtml2odt(html, dict(url="http://localhost/localpage"))
        self.assertEquals(odt, '<text:a xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="http://somewhere.else/otherpage#target">Test</text:a>')
    ...
    def test_a_target_4(self):
        ...
        odt = xhtml2odt(html, dict(url="http://localhost/localpage"))
        self.assertEquals(odt, '<text:a xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="http://localhost/localpage/otherpage#target">Test</text:a>')

    def test_a_bookmark(self):
        """<a> tag: bookmark"""
        html = '<html xmlns="http://www.w3.org/1999/xhtml"><a id="target">Test</a></html>'
        odt = xhtml2odt(html)
        self.assertEquals(odt, '<text:a xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href=""><text:bookmark-start text:name="target"/>Test<text:bookmark-end text:name="target"/></text:a>')
